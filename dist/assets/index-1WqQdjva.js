import{B as $,D as h,aj as S,s as v,o as u,c,f as d,m as a,e as z,O as f,Z as B,r as p,a4 as I,E as P,F as i,w as A,g as s,a5 as g,a6 as C}from"./index-eF724wvI.js";import{a as j}from"./index-BGWMpRJm.js";var O=({dt:n})=>`
.p-badge {
    display: inline-flex;
...
`,T={root:function(t){var o=t.props,r=t.instance;return["p-badge p-component",{"p-badge-circle":S(o.value)&&String(o.value).length===1,"p-badge-dot":h(o.value)&&!r.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},N=$.extend({name:"badge",style:O,classes:T}),F={name:"BaseBadge",extends:v,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:N,provide:function(){return{$pcBadge:this,$parentInstance:this}}},y={name:"Badge",extends:F,inheritAttrs:!1};function D(n,t,o,r,k,l){return u(),c("span",a({class:n.cx("root")},n.ptmi("root")),[d(n.$slots,"default",{},function(){return[z(f(n.value),1)]})],16)}y.render=D;var E=({dt:n})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
