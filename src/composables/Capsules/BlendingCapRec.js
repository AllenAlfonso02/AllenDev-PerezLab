// composables/postlogic/postBlendingCapRec.js
import axios from 'axios';
import { ref, unref } from 'vue';

const lambdaUrl = '';

export default function useBlendingCapRec() {
    const loading = ref(false);
    const errors = ref(null);
    const successData = ref(null);

    const postBlendingCapRec = async (payloadLike) => {
        loading.value = true;
        errors.value = null;
        try {
    ...
    return { loading, errors, successData, postBlendingCapRec };
}
