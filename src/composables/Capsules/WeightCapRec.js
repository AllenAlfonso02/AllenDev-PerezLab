// composables/postlogic/postWeightCapRec.js
import axios from 'axios';
import { ref, unref } from 'vue';

const lambdaUrl = '';

export default function useWeightCapRec() {
    const loading = ref(false);
    const errors = ref(null);
    const successData = ref(null);

    const postWeightCapRec = async (payloadLike) => {
        loading.value = true;
        errors.value = null;
        try {
    ...
    return { loading, errors, successData, postWeightCapRec };
}
