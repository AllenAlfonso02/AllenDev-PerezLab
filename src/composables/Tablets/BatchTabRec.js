// composables/postlogic/postBatchTabRec.js
import axios from 'axios';
import { ref, unref } from 'vue';

const lambdaUrl = '';

export default function useBatchTabRec() {
    const loading = ref(false);
    const errors = ref(null);
    const successData = ref(null);

    const postBatchTabRec = async (payloadLike) => {
        loading.value = true;
        errors.value = null;
        try {
    ...
    return { loading, errors, successData, postBatchTabRec };
}
